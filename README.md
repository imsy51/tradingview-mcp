...
> Install the TradingView MCP server. Clone https://github.com/imsy51/tradingview-mcp.git, run npm install, add it to my MCP config at ~/.claude/.mcp.json, and launch TradingView with the debug port. Then verify the connection with tv_health_check.
...
```bash
git clone https://github.com/imsy51/tradingview-mcp.git
cd tradingview-mcp
npm install
```
